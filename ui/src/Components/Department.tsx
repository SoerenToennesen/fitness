...
export class Department extends Component<MyProps, MyStates> {
    ...
    changeDepartmentIdFilter = (e: any) => {
        this.setState({DepartmentIdFilter: e.target.value});
        this.FilterFn();
    }
    changeDepartmentNameFilter = (e: any) => {
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div className="input-group mb-3">
                                    ...
                                    onChange={this.changeDepartmentName}></input>
                                </div>
                                {DepartmentId === 0 ?
                                <button 
                                    type="button"
